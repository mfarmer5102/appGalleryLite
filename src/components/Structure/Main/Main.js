...
class Main extends Component {
    ...
    fetchApplicationsData = () => {
        let url = 'https://central-api-node-2-6wevi67jwa-uc.a.run.app' + "/AppGalleryLite/api/applications";
        fetch(url)
    ...
    fetchKeywordsData = () => {
        let url = 'https://central-api-node-2-6wevi67jwa-uc.a.run.app' + "/AppGalleryLite/api/keywords";
        fetch(url)
            .then(response => response.json())
            .then(response => {
                this.setState({
