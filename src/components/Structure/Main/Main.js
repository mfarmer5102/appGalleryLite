...
class Main extends Component {
    ...
    fetchApplicationsData = () => {
        let url = 'http://ec2-184-72-206-184.compute-1.amazonaws.com/' + "/AppGalleryLite/api/applications";
        fetch(url)
    ...
    fetchKeywordsData = () => {
        let url = 'http://ec2-184-72-206-184.compute-1.amazonaws.com/' + "/AppGalleryLite/api/keywords";
        fetch(url)
            .then(response => response.json())
            .then(response => {
                this.props.removeLoadingScreen();
